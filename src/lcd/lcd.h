...
#define LCD_RS_DIR1  P1M1
#define LCD_RS_DIR2  P1M2
#define LCD_RS_BIT  (1 << 2)

// EN of LCD Direction,OUTPUT and Bit Position
#define LCD_EN_PORT P1
#define LCD_EN_DIR1  P1M1
#define LCD_EN_DIR2  P1M2
#define LCD_EN_BIT  (1 << 0)
...
#define LCD_D4_PORT P0
#define LCD_D4_DIR1  P0M1
#define LCD_D4_DIR2  P0M2
#define LCD_D4_BIT  (1 << 1)

// D5 of LCD Direction,OUTPUT and Bit Position
#define LCD_D5_PORT P0
#define LCD_D5_DIR1  P0M1
#define LCD_D5_DIR2  P0M2
...
#define LCD_D7_PORT P0
#define LCD_D7_DIR1  P0M1
#define LCD_D7_DIR2  P0M2
#define LCD_D7_BIT  (1 << 4)
